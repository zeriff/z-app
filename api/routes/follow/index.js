...
var bind_pin_api = function(router) {
    ...
    router.route("/follow/status/:user_id").get(getFollowingStatus)
}
...
function getFollowers(req, res) {
    ...
    Follow.getFollowers(user_id).then(function(followers) {
        res.json({success: true, followers: followers.length});
    });
}
...
function getFollowing(req, res) {
    ...
    Follow.getFollowing(user_id).then(function(following) {
        res.json({success: true, following: following.length});
    });
}
