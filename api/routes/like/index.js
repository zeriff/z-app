...
*
*/
    router.route("/likes/:pin_id").get(auth.authorize_user, likePin).delete(auth.authorize_user, unLikePin);
    /**
* @swagger
...
*/
    router.route("/likes/:pin_id/count").get(getTotalLikes);
    /**
* @swagger
...
*
*/
    router.route("/likes/:pin_id/status").get(getLikeStatus);
}
